...
aimee_dress = Garment(
				...
				pic = Picture(title="Aimee Dress - 衬衫", image='http://assets.modeflip.com/eileen/collections/squibees/garments/aimee_dress/cover.jpg'),
				details=[
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/aimee_dress/details/0.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/aimee_dress/details/1.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/aimee_dress/details/2.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/aimee_dress/details/3.jpg'),
						]
				)
...
chappy_blouse = Garment(
				...
				pic = Picture(title="Chappy Blouse - 衬衫", image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/cover.jpg'),
				details=[
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/details/0.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/details/1.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/details/2.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/details/3.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/details/4.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/details/5.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/details/6.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/chappy_blouse/details/7.jpg'),
						]
				)
...
lili_dress = Garment(
				...
				pic = Picture(title="Lili Dress - 连衣裙", image='http://assets.modeflip.com/eileen/collections/squibees/garments/lili_dress/cover.jpg'),
				details=[
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lili_dress/details/0.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lili_dress/details/1.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lili_dress/details/2.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lili_dress/details/3.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lili_dress/details/4.jpg'),
						]
				)
...
lucy_dress = Garment(
				...
				pic = Picture(title="Lucy Dress - 连衣裙", image='http://assets.modeflip.com/eileen/collections/squibees/garments/lucy_dress/cover.jpg'),
				details=[
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lucy_dress/details/0.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lucy_dress/details/1.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lucy_dress/details/2.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lucy_dress/details/3.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lucy_dress/details/4.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lucy_dress/details/5.jpg'),
					Picture(image='http://assets.modeflip.com/eileen/collections/squibees/garments/lucy_dress/details/6.jpg'),
						]
				)
