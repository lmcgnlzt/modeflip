...
experience_content = ExperienceContent(
	...
	pages = [
		PicturePage(
			pics = [
				Picture(thumbnail='http://assets.modeflip.com/eileen/experience/pics/1s.jpg', image='http://assets.modeflip.com/eileen/experience/pics/1.jpg'),
				Picture(thumbnail='http://assets.modeflip.com/eileen/experience/pics/2s.jpg', image='http://assets.modeflip.com/eileen/experience/pics/2.jpg'),
				Picture(thumbnail='http://assets.modeflip.com/eileen/experience/pics/3s.jpg', image='http://assets.modeflip.com/eileen/experience/pics/3.jpg'),
				Picture(thumbnail='http://assets.modeflip.com/eileen/experience/pics/4s.jpg', image='http://assets.modeflip.com/eileen/experience/pics/4.jpg'),
				Picture(thumbnail='http://assets.modeflip.com/eileen/experience/pics/5s.jpg', image='http://assets.modeflip.com/eileen/experience/pics/5.jpg'),
		...
		PicturePage(
			pics = [
				...
				Picture(thumbnail='http://assets.modeflip.com/eileen/experience/pics/14s.jpg', image='http://assets.modeflip.com/eileen/experience/pics/14.jpg'),
				Picture(thumbnail='http://assets.modeflip.com/eileen/experience/pics/5s.jpg', image='http://assets.modeflip.com/eileen/experience/pics/5.jpg'),
				# Picture(thumbnail='http://assets.modeflip.com/eileen/images/pics/7s.jpg', image='http://assets.modeflip.com/eileen/images/pics/7.jpg'),
				# Picture(thumbnail='http://assets.modeflip.com/eileen/images/pics/8s.jpg', image='http://assets.modeflip.com/eileen/images/pics/8.jpg'),
			]
		)
	],
...
garments_july = [
	Garment(
		...
		pic = Picture(
			thumbnail='http://assets.modeflip.com/eileen/collections/201607/garments/1/pre1s.jpg',
			image='http://assets.modeflip.com/eileen/collections/201607/garments/1/pre1.jpg',
			title='蕾丝花边裙',
			),
		more_pics = [
	...
	Garment(
		...
		shop_link='http://shop_link',
		pic = Picture(
			thumbnail='http://assets.modeflip.com/eileen/collections/201607/garments/2/new1s.jpg',
			image='http://assets.modeflip.com/eileen/collections/201607/garments/2/1s.jpg',
			title='无袖开衩长裙',
			),
		more_pics = [
...
garments_june = [
	Garment(
		...
		shop_link='http://shop_link',
		pic = Picture(
			thumbnail='http://assets.modeflip.com/eileen/collections/201606/garments/1/pre1s.jpg',
			image='http://assets.modeflip.com/eileen/collections/201606/garments/1/pre1.jpg',
			title='复古开叉长裙',
			),
		more_pics = [
			Picture(title="细节1", image='http://assets.modeflip.com/eileen/collections/201606/garments/1/details/1.jpg'),
			Picture(title="细节2", image='http://assets.modeflip.com/eileen/collections/201606/garments/1/details/2.jpg'),
			Picture(title="细节3", image='http://assets.modeflip.com/eileen/collections/201606/garments/1/details/3.jpg'),
			Picture(title="细节4", image='http://assets.modeflip.com/eileen/collections/201606/garments/1/details/4.jpg'),
			]
		),
	Garment(
		gid=2,
		shop_link='http://shop_link',
		pic = Picture(
			thumbnail='http://assets.modeflip.com/eileen/collections/201606/garments/2/new1s.jpg',
			image='http://assets.modeflip.com/eileen/collections/201606/garments/2/1s.jpg',
			title='镂空两件套裙',
			),
		more_pics = [
			Picture(title="细节1", image='http://assets.modeflip.com/eileen/collections/201606/garments/2/details/1.jpg'),
			Picture(title="细节2", image='http://assets.modeflip.com/eileen/collections/201606/garments/2/details/2.jpg'),
			]
		),
	]
