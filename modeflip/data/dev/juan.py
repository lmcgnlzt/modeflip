...
experience_content = ExperienceContent(
	...
	pic_title='',
	pics = [
		Picture(thumbnail='images/resources/juan/experience/pics/1s.jpg', image='images/resources/juan/experience/pics/1.jpg', title='1'),
		Picture(thumbnail='images/resources/juan/experience/pics/2s.jpg', image='images/resources/juan/experience/pics/2.jpg', title='2'),
		Picture(thumbnail='images/resources/juan/experience/pics/3s.jpg', image='images/resources/juan/experience/pics/3.jpg', title='3'),
		Picture(thumbnail='images/resources/juan/experience/pics/4s.jpg', image='images/resources/juan/experience/pics/4.jpg', title='4'),
		Picture(thumbnail='images/resources/juan/experience/pics/5s.jpg', image='images/resources/juan/experience/pics/5.jpg', title='5'),
		...
		Picture(thumbnail='images/resources/juan/experience/pics/9s.jpg', image='images/resources/juan/experience/pics/9.jpg'),
		Picture(thumbnail='images/resources/juan/experience/pics/10s.jpg', image='images/resources/juan/experience/pics/10.jpg'),
...
exclusive_content = ExclusiveContent(
	...
	videos=[
		Video(
				thumbnail='images/resources/juan/exclusive/videos/thumbnail.png',
				poster='images/resources/juan/exclusive/videos/thumbnail.jpg',
...
c_july = Collection(
		...
		signatrue_videos=[
			Video(
				thumbnail='images/resources/juan/collections/201607/signature/videos/thumbnail.png',
				poster='images/resources/juan/collections/201607/signature/videos/thumbnail.jpg',
...
g_july_1 = Garment(
				...
				pic = Picture(title="蕾丝花边裙", image='images/resources/juan/collections/201607/garments/1/pre1.jpg'),
				details=[
					Picture(title="蕾丝花边裙", image='images/resources/juan/collections/201607/garments/1/pre1.jpg'),
...
g_july_2 = Garment(
				...
				pic = Picture(title="蕾丝花边裙", image='images/resources/juan/collections/201607/garments/1/pre1.jpg'),
				details=[
					Picture(title="无袖开衩长裙", image='images/resources/juan/collections/201607/garments/2/1s.jpg'),
