	...
	pages = [
		...
		PicturePage(
			pics = [
				...
				Picture(thumbnail='images/resources/sophia/experience/pics/5s.jpg', image='images/resources/sophia/experience/pics/5.jpg'),
				Picture(thumbnail='images/resources/sophia/experience/pics/6s.jpg', image='images/resources/sophia/experience/pics/6.jpg'),
				Picture(thumbnail='images/resources/sophia/experience/pics/7s.jpg', image='images/resources/sophia/experience/pics/7.jpg'),
				Picture(thumbnail='images/resources/sophia/experience/pics/8s.jpg', image='images/resources/sophia/experience/pics/8.jpg'),
			]
		...
		PicturePage(
			pics = [
				Picture(thumbnail='images/resources/sophia/experience/pics/1s.jpg', image='images/resources/sophia/experience/pics/1.jpg'),
				Picture(thumbnail='images/resources/sophia/experience/pics/2s.jpg', image='images/resources/sophia/experience/pics/2.jpg'),
				Picture(thumbnail='images/resources/sophia/experience/pics/12s.jpg', image='images/resources/sophia/experience/pics/12.jpg'),
				Picture(thumbnail='images/resources/sophia/experience/pics/13s.jpg', image='images/resources/sophia/experience/pics/13.jpg'),
				Picture(thumbnail='images/resources/sophia/experience/pics/14s.jpg', image='images/resources/sophia/experience/pics/14.jpg'),
				Picture(thumbnail='images/resources/sophia/experience/pics/5s.jpg', image='images/resources/sophia/experience/pics/5.jpg'),
				# Picture(thumbnail='images/resources/sophia/images/pics/7s.jpg', image='images/resources/sophia/images/pics/7.jpg'),
				# Picture(thumbnail='images/resources/sophia/images/pics/8s.jpg', image='images/resources/sophia/images/pics/8.jpg'),
			]
		)
	],
...
exclusive_content = ExclusiveContent(
	...
	videos=[
		Video(
				thumbnail='images/resources/sophia/exclusive/videos/thumbnail.jpg',
...
garments_july = [
	Garment(
		...
		pic = Picture(
			thumbnail='images/resources/sophia/collections/201607/garments/1/pre1s.jpg',
			image='images/resources/sophia/collections/201607/garments/1/pre1.jpg',
			title='蕾丝花边裙',
			),
		more_pics = [
	...
	Garment(
		...
		shop_link='http://shop_link',
		pic = Picture(
			thumbnail='images/resources/sophia/collections/201607/garments/2/new1s.jpg',
			image='images/resources/sophia/collections/201607/garments/2/1s.jpg',
			title='无袖开衩长裙',
			),
		more_pics = [
...
garments_june = [
	Garment(
		...
		shop_link='http://shop_link',
		pic = Picture(
			thumbnail='images/resources/sophia/collections/201606/garments/1/pre1s.jpg',
			image='images/resources/sophia/collections/201606/garments/1/pre1.jpg',
			title='复古开叉长裙',
			),
		more_pics = [
			Picture(title="细节1", image='images/resources/sophia/collections/201606/garments/1/details/1.jpg'),
			Picture(title="细节2", image='images/resources/sophia/collections/201606/garments/1/details/2.jpg'),
			Picture(title="细节3", image='images/resources/sophia/collections/201606/garments/1/details/3.jpg'),
			Picture(title="细节4", image='images/resources/sophia/collections/201606/garments/1/details/4.jpg'),
			]
		),
	Garment(
		gid=2,
		shop_link='http://shop_link',
		pic = Picture(
			thumbnail='images/resources/sophia/collections/201606/garments/2/new1s.jpg',
			image='images/resources/sophia/collections/201606/garments/2/1s.jpg',
			title='镂空两件套裙',
			),
		more_pics = [
			Picture(title="细节1", image='images/resources/sophia/collections/201606/garments/2/details/1.jpg'),
			Picture(title="细节2", image='images/resources/sophia/collections/201606/garments/2/details/2.jpg'),
			]
		),
	]
...
collections = [
	Collection(
		...
		signatrue_videos=[
			Video(
				thumbnail='images/resources/sophia/collections/201607/signature/videos/thumbnail.jpg',
...
bio1 = "1954年，圣.洛朗参加国际羊毛局举办的设计大奖赛，以一套黑色鸡尾酒会服荣获女装一等奖，以此为契机进入迪奥尔店的主任设计师。60年代的后半期，圣.洛朗使自己的高级时装和高级成衣遍及全世界，1971年春他推出沙漏形的40年代风格，掀起一阵回归潮, 1974年秋他发表哥萨克风格，引起民族风格服装的流行。直到现在，他仍是巴黎时装界举足轻重的一位设计师。"
